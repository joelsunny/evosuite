...
basefolder="/home/ubuntu/joel/ulysis/exps/${projectname}_exps_1"
...
#		mkdir -p /home/abhijitc/neural_project/results/evo_itr_dump/Closure/temp2/bug"$i"/"$j"
		...
		"$d4j_home"/defects4j/framework/bin/run_evosuite.pl -p ${projectname} -v "$i"f -n "$bugid" -o "$basefolder/$bugfolder/$iteration" -c VCMDDU2 -b 60 -t "$basefolder/$evo_temp/$iteration"
